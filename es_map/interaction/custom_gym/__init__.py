...
register(
    ...
    entry_point='es_map.interaction.custom_gym.mujoco:HumanoidDeceptive',
)


register(
    id='AntMaze-v2',
    entry_point='es_map.interaction.custom_gym.mujoco:AntObstaclesBigEnv',
    max_episode_steps=3000,
)

register(
    id='DamageAnt-v2',
    entry_point='es_map.interaction.custom_gym.mujoco:AntEnv',
